...
export const embeddingTargets: EmbeddingTarget[] = [
  {
    ...
    placeholderUrl:
      'https://db.learningforkidz.com/dashboard/#/nc/pmrh4kweqadj3e0/mi1wguypfkab12u',
    status: 'ready',
    ...
    defaultLimit: 50,
    integrationNotes:
      'This view streams from the shared NocoDB dashboard. Manage permissions from NocoDB and rotate share links if exposure needs to be revoked.'
    ,
    manageUrl:
      'https://db.learningforkidz.com/dashboard/#/nc/pmrh4kweqadj3e0/mi1wguypfkab12u'
  },
  {
    ...
    placeholderUrl:
      'https://db.learningforkidz.com/dashboard/#/nc/pmrh4kweqadj3e0/myud6cs8uhz9vl1',
    status: 'ready',
    ...
    defaultLimit: 50,
    integrationNotes:
      'Ensure the shared view stays read-only for analysts who only need visibility into customer classifications.'
    ,
    manageUrl:
      'https://db.learningforkidz.com/dashboard/#/nc/pmrh4kweqadj3e0/myud6cs8uhz9vl1'
  },
  {
    ...
    placeholderUrl:
      'https://db.learningforkidz.com/dashboard/#/nc/pmrh4kweqadj3e0/mnrsvmnrbcqqeng',
    status: 'ready',
    ...
    defaultLimit: 50,
    integrationNotes:
      'Keep this embed scoped to sanitized data; use NocoDB filters/roles if sensitive columns are added later.'
    ,
    manageUrl:
      'https://db.learningforkidz.com/dashboard/#/nc/pmrh4kweqadj3e0/mnrsvmnrbcqqeng'
  },
  {
    ...
    placeholderUrl:
      'https://db.learningforkidz.com/dashboard/#/nc/pmrh4kweqadj3e0/m2ej2yiy750wwfh',
    status: 'ready',
    ...
    defaultLimit: 50,
    integrationNotes:
      'Adjust the share link each quarter if the quota sheet moves; iframe will auto-refresh with the updated URL.'
    ,
    manageUrl:
      'https://db.learningforkidz.com/dashboard/#/nc/pmrh4kweqadj3e0/m2ej2yiy750wwfh'
  }
